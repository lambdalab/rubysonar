...
public class Demo {
    ...
    private static final String CSS = $.readResource("org/yinwang/rubysonar/css/demo.css");
    private static final String JS = $.readResource("org/yinwang/rubysonar/javascript/highlight.js");
    private static final String JS_DEBUG = $.readResource("org/yinwang/rubysonar/javascript/highlight-debug.js");
...
//        String outline = new HtmlOutline(analyzer).generate(path);
    ...
    private static void usage() {
        $.msg("Usage:  java -jar rubysonar-2.0-SNAPSHOT.jar <file-or-dir> <output-dir>");
        $.msg("Example that generates an index for Python 2.7 standard library:");
        $.msg(" java -jar rubysonar-2.0-SNAPSHOT.jar /usr/lib/python2.7 ./html");
        System.exit(0);
    }
